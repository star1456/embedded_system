...
public:
    ...
    void run()
    {
        ...
        SocketAddress address("the socket address");
        ...
        while (1){
            ...
            "{\"acc_x\":%d,\"acc_y\":%d,\"acc_z\":%d, \"gyro_x\":%.2f,\"gyro_y\":%.2f,\"gyro_z\":%.2f, \"mag_x\":%d,\"mag_y\":%d,\"mag_z\":%d,\"t\":%.2f,\"h\":%.2f,\"p\":%.2f, \"s\":%d}", 
            pAccDataXYZ[0], pAccDataXYZ[1], pAccDataXYZ[2],pGyroDataXYZ[0], pGyroDataXYZ[1], pGyroDataXYZ[2],pMagDataXYZ[0], pMagDataXYZ[1], pMagDataXYZ[2], t, h, p, sample_num);
